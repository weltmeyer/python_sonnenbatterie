...
async def test_timeofuse():
    ...
    orig_battery_tou_string = await sb.sb2.get_tou_schedule_string()
    orig_battery_tou_json = await sb.sb2.get_tou_schedule_json()
    pprint(await sb.sb2.get_tou_schedule_string())
    print("\nExtract tou schedule as json objects")
    pprint(await sb.sb2.get_tou_schedule_json())
    print("\nExtract tou schedule as text schedule")
    pprint(await sb.sb2.get_tou_schedule_object())
    print("\nLoad tou schedule from json")
    tous.load_tou_schedule_from_json(await sb.sb2.get_tou_schedule_json())
    print("\nLoaded tou schedule")
    ...
    await sb.sb2.set_tou_schedule_json(tous_new.get_as_tou_schedule())
    ...
    await sb.sb2.set_tou_schedule_json(orig_battery_tou_json)
    print("Sleeping for 60 seconds so you can check the change has been applied")
    time.sleep(60)

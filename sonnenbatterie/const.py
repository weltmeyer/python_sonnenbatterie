...
BATTERY_LOGIN_TIMEOUT=120
CONNECT_TO_BATTERY_TIMEOUT=10
READ_FROM_BATTERY_TIMEOUT=10
REQUEST_TIMEOUT=Timeout(connect=CONNECT_TO_BATTERY_TIMEOUT, read=READ_FROM_BATTERY_TIMEOUT)
